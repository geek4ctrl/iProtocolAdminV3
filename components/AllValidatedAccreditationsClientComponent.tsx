...
export default function AllValidatedAccreditationsClientComponent({ allValidatedAccreditations }: { allValidatedAccreditations: any }) {
    ...
    const qrCodeContent = `https://i-protocol-control-v3.vercel.app/?userId=${modalContent.userid}&reservationType=${modalContent.reservationtype}&invitationStatus=${modalContent.invitationstatus}`
